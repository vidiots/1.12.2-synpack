...
val oreDictBlockFuelCoke = <ore:blockFuelCoke>;
oreDictBlockFuelCoke.add(<railcraft:generic:6>);

// Fix Atomic Battery recipe's lead compatibility
recipes.removeByRecipeName("galacticraftplanets:atomic_battery");
recipes.addShaped(<galacticraftplanets:atomic_battery>,
													[[oreDict.ingotLead, oreDict.ingotLead, oreDict.ingotLead],
													[oreDict.ingotLead, <galacticraftplanets:basic_item_venus:2>, oreDict.ingotLead],
													[oreDict.ingotLead,  oreDict.ingotLead, oreDict.ingotLead]]);